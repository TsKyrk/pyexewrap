"""Reset .py and .pyw file associations back to the standard py.exe launcher.

Removes pyexewrap from the handler chain and restores the plain py.exe command
for every effective Python ProgID.
...
def main():
    ...
    print("\nDone. .py and .pyw files now open directly with py.exe.")
