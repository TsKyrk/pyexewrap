# How to Register a File Type for a New Application - Win32 apps | Microsoft Learn

Source: https://learn.microsoft.com/en-us/windows/win32/shell/how-to-register-a-file-type-for-a-new-application
...
If you plan to associate the file with an existing application, locate an application ProgID in the registry. For more information, see [File Types](fa-file-types).
