# Verbs and File Associations - Win32 apps | Microsoft Learn

Source: https://learn.microsoft.com/en-us/windows/win32/shell/fa-verbs
...
To extend the shortcut menu for a file type, you must create a registry entry for each command. A more sophisticated approach is to implement a shortcut menu (verb) handler, which allows you to extend the shortcut menu for a file type on a file-by-file basis. For more information, see [Creating Context Menu Handlers](context-menu-handlers), and [Context Menu Reference](context-menu-reference).
